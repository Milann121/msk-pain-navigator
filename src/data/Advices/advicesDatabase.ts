...
export const advices: Advice[] = [
  // Advice 1 - Regular Position Change
  {
    ...
    adviceImageUrl: "public/lovable-uploads/adviceImages/adviceImage1.svg",
    adviceLink: "",
  ...
  // Advice 3 - Sleep Positions
  {
    ...
    adviceImageUrl: "public/lovable-uploads/adviceImages/adviceImage3.svg",
    adviceLink:"",
  ...
  // Advice 4 - Lumbar Pad
  {
    ...
    adviceImageUrl: "public/lovable-uploads/adviceImages/adviceImage4.svg",
    adviceLink:"",
  ...
  // Advice 5 - Object lifting
  {
    ...
    adviceImageUrl: "public/lovable-uploads/adviceImages/adviceImage5.svg",
    adviceLink:"",
    bodyParts: ['lower-back'],
    mechanisms: ['nociceptive', 'neuropathic'],
  ...
  // Advice 6 - Superman sleep position
  {
    ...
    adviceImageUrl: "public/lovable-uploads/adviceImages/adviceImage6.svg",
    adviceLink:"",
