...
export const middleBackExercises = {
  ...
  'nociceptive-default-middle back': [
    {
      title: 'exercises.middleBackNociceptive.defaultNociceptive.title',
      description: 'exercises.middleBackNociceptive.defaultNociceptive.description',
      videos: [
        {
          videoId: 'dQw4w9WgXcQ',
          title: 'exercises.middleBackNociceptive.defaultNociceptive.basicMobility.title',
          description: 'exercises.middleBackNociceptive.defaultNociceptive.basicMobility.description',
          importance: 1,
          bodyPart: 'middle back',
        ...
        {
          videoId: 'dQw4w9WgXcQ',
          title: 'exercises.middleBackNociceptive.defaultNociceptive.basicStrengthening.title',
          description: 'exercises.middleBackNociceptive.defaultNociceptive.basicStrengthening.description',
          importance: 2,
          bodyPart: 'middle back',
          mainGroup: 'strengthening'
        }
      ]
    }
  ]
