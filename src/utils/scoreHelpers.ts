...
export const differentialDescriptions: Record<Differential, string> = {
  ...
  'spinal stenosis': 'Vaše príznaky naznačujú stenózu chrbtice, čo je zúženie chrbtičného kanála.',
  'spondylolisthesis': 'Vaše príznaky naznačujú spondylolistézu, čo je posun stavca.',
  'nerve compression': 'Vaše príznaky naznačujú kompresiu nervu.',
  'peripheral neuropathy': 'Vaše príznaky naznačujú periférnu neuropatiu.',
  'fibromyalgia': 'Vaše príznaky naznačujú fibromyalgiu.',
