...
export const SectionCard = ({
  ...
  return <Card className="cursor-pointer hover:shadow-lg transition-shadow border-border bg-secondary" onClick={handleClick}>
      <CardContent className="p-4">
        <div className="flex flex-col items-center gap-3">
          ...
          <h3 className="text-primary text-center text-base font-bold">
            {title}
          </h3>
        </div>
      </CardContent>
