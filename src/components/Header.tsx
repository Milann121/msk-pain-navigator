...
const Header = () => {
            ...
            {navigationLinks.map((link) => (
              <li key={link.label}>
                <Button
                  ...
                  variant="ghost"
                  className="w-full text-left justify-start px-4 py-2 text-lg hover:bg-accent rounded-md transition-colors"
                >
                  {link.label}
                </Button>
              </li>
  ...
  return (
    <header className="bg-gradient-primary text-primary-foreground py-4 px-3 md:px-6 shadow-md">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <nav className="hidden lg:flex items-center space-x-6">
          ...
          <Button
            onClick={handleAuthClick}
            variant="outline"
            className="bg-primary-foreground text-primary hover:bg-accent border-primary-foreground"
          >
            {user ? t('header.signOut') : t('header.signIn')}
          </Button>
        </nav>
