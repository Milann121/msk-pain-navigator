...
const WelcomeOverlay = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="w-full bg-accent/20 relative">
        <div className="w-full h-full min-h-[400px] relative">
          <img
          ...
          <div className="absolute inset-0 flex items-center justify-end px-4 md:px-8">
            <div className="bg-card/90 backdrop-blur-sm p-6 md:p-8 rounded-lg shadow-lg max-w-md md:max-w-lg space-y-4 mr-4 md:mr-8">
              <h3 className="text-2xl font-bold text-gradient-primary">{t('welcome.calendar.title')}</h3>
      ...
      <div className="w-full relative">
        <div className="w-full h-full min-h-[400px] relative">
          ...
          <div className="absolute inset-0 flex items-center justify-start px-4 md:px-8">
            <div className="bg-card/90 backdrop-blur-sm p-6 md:p-8 rounded-lg shadow-lg max-w-md md:max-w-lg space-y-4 ml-4 md:ml-8">
              <h3 className="text-2xl font-bold text-gradient-primary">{t('welcome.programs.title')}</h3>
              <p className="text-foreground leading-relaxed">
      ...
      <div className="w-full bg-accent/20 relative">
        <div className="w-full h-full min-h-[400px] relative">
          ...
          <div className="absolute inset-0 flex items-center justify-end px-4 md:px-8">
            <div className="bg-card/90 backdrop-blur-sm p-6 md:p-8 rounded-lg shadow-lg max-w-md md:max-w-lg space-y-4 mr-4 md:mr-8">
              <h3 className="text-2xl font-bold text-gradient-primary">{t('welcome.assessment.title')}</h3>
              <p className="text-foreground leading-relaxed">
      ...
      <footer className="bg-gradient-primary text-primary-foreground py-4 px-3 md:px-6 shadow-md mt-auto">
