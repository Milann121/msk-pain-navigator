        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-3 mb-4">
              {!hasCompletedRecently && (
                <Button onClick={onTakeQuestionnaire} className="bg-green-600 hover:bg-green-700 text-white" size="sm">
              ...
              {hasCompletedRecently && (
                <Button onClick={onViewResults} className="bg-green-600 hover:bg-green-700 text-white" size="sm">
