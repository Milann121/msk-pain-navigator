...
const Stretching = () => {
  ...
  const filterButtons = [
    { key: "all", label: t('stretching.filters.all') },
    { key: "at_desk", label: t('stretching.filters.at_desk') },
    { key: "morning", label: t('stretching.filters.morning') },
    { key: "warm_up", label: t('stretching.filters.warm_up') },
    { key: "after_training", label: t('stretching.filters.after_training') },
    { key: "better_regeneration", label: t('stretching.filters.better_regeneration') },
    { key: "mid_day", label: t('stretching.filters.mid_day') },
    { key: "before_sleep", label: t('stretching.filters.before_sleep') },
    { key: "at_work", label: t('stretching.filters.at_work') },
  ];
  ...
  const stretchingCards: StretchingCard[] = [
    {
      id: "1",
      image: "/lovable-uploads/my_exercisePage_containers/1.png",
    ...
    {
      id: "2", 
      image: "/lovable-uploads/my_exercisePage_containers/7.png",
    ...
    {
      id: "3",
      image: "/lovable-uploads/my_exercisePage_containers/8.png", 
    ...
    {
      id: "4",
      image: "/lovable-uploads/my_exercisePage_containers/11.png",
  ...
  const filteredCards = activeFilter === "all" 
    ? stretchingCards 
    : stretchingCards.filter(card => card.stretch_group.includes(activeFilter));
