...
const Domov = () => {
  ...
  if (isLoading || isCheckingProfile) {
    return (
      <div className="min-h-screen flex flex-col">
        <Header />
        <div className="flex-1 bg-gradient-to-b from-accent/20 to-background py-10 px-4 flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Header />
      <div className="flex-1 bg-gradient-to-b from-accent/20 to-background py-10 px-2 md:px-4">
